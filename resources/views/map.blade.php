<x-app-layout>
    ...
    <div x-data="{ open: false }" class="fixed top-20 right-4 z-40">
        <button 
            @click="open = !open"
            class="flex items-center space-x-2 px-4 py-2 bg-white/90 dark:bg-gray-800/90 text-gray-700 dark:text-gray-200 rounded-lg shadow-lg hover:bg-white dark:hover:bg-gray-700 backdrop-blur-sm"
        >
        ...
        >
            <div class="p-4 space-y-4">
                ...
                <div>
                    ...
                    <select id="dateFilter" class="w-full rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200">
                    ...
                    <div class="space-y-2 max-h-48 overflow-y-auto">
                        @foreach($crimeTypes as $type)
                            <label class="flex items-center">
                                <input type="checkbox" value="{{ $type->id }}" class="rounded border-gray-300 dark:border-gray-600 text-indigo-600 dark:text-indigo-400">
    ...
    {{-- Location Button --}}
    <button id="locate-btn" class="fixed bottom-20 right-4 z-40 p-3 bg-gray-800/90 dark:bg-white/90 text-gray-200 dark:text-gray-700 rounded-full shadow-lg hover:bg-gray-700 dark:hover:bg-white backdrop-blur-sm">
